      ...
      <section className="gameMenu">
        ...
        <section className="stickyMenus">
          <article className="charactersContainer">
            <ul>
              <li>
                <p>{gameData.characters[0].name}</p>
                <img src={`characters/${gameData.characters[0].img}`} />
              </li>
              <li>
                <p>{gameData.characters[1].name}</p>
                <img src={`characters/${gameData.characters[1].img}`} />
              </li>
              <li>
                <p>{gameData.characters[2].name}</p>
                <img src={`characters/${gameData.characters[2].img}`} />
              </li>
            </ul>
        ...
        <img
          ...
          src={`/${selectedGame}.png`}
          alt={`Big image of a ${selectedGame}`}
        />
      </section>
    </>
  );
